//! # Sekai Robot Kit
//!
//! A standalone robotics toolkit that integrates with Sekai for AI-powered robots.
//!
//! ## Features
//!
...
//! ```text
//! ┌─────────────────────────────────────────────────────────┐
//! │  Sekai AI Brain (or any controller)                  │
...
//!
//! ```rust,ignore
//! use sekai_robot_kit::{RobotConfig, DriveTool, SafetyMonitor, SafeDrive};
//! use std::sync::Arc;
//!
//! #[tokio::main]
//! async fn main() {
...
//! ## Standalone Usage
//!
//! This crate can be used independently of Sekai. It defines its own
//! `Tool` trait that is compatible with Sekai's but doesn't require it.
//!
//! ## Safety
//!
