...
use sekai_config::schema::MqttConfig;
use sekai_runtime::sop::audit::SopAuditLogger;
use sekai_runtime::sop::dispatch::{dispatch_sop_event, process_headless_results};
use sekai_runtime::sop::engine::{SopEngine, now_iso8601};
use sekai_runtime::sop::types::{SopEvent, SopTriggerSource};
...
pub async fn run_mqtt_sop_listener(
    ...
    sekai_runtime::health::mark_component_ok("mqtt");
    ...
    loop {
        match eventloop.poll().await {
            ...
            Err(e) => {
                sekai_runtime::health::mark_component_error("mqtt", e.to_string());
