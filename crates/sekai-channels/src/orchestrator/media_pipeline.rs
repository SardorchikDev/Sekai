...
use sekai_config::schema::{MediaPipelineConfig, TranscriptionConfig};

// Re-export media types from sekai-types for backwards compatibility.
pub use sekai_api::media::{MediaAttachment, MediaKind};
