...
//! session_path = "~/.sekai/whatsapp-session.db"  # Required for Web mode
...
/// ```toml
/// [channels_config.whatsapp]
/// session_path = "~/.sekai/whatsapp-session.db"
...
pub struct WhatsAppWebChannel {
    ...
    mode: sekai_config::schema::WhatsAppWebMode,
    /// DM policy when mode = personal
    dm_policy: sekai_config::schema::WhatsAppChatPolicy,
    /// Group policy when mode = personal
    group_policy: sekai_config::schema::WhatsAppChatPolicy,
...
impl WhatsAppWebChannel {
    ...
    async fn try_transcribe_voice_note(
        ...
        transcription_config: Option<&sekai_config::schema::TranscriptionConfig>,
                    ...
                    async move {
                        match event {
                            Event::Message(msg, info) => {
                                ...
                                if wa_mode == sekai_config::schema::WhatsAppWebMode::Personal {
                                        ...
                                        )
                                    {
                                        ...
                                        match wa_group_policy {
                                            sekai_config::schema::WhatsAppChatPolicy::Ignore => {
                                                tracing::debug!(
                                                    "WhatsApp Web: ignoring group message (group_policy=ignore)"
                                                );
                                                return;
                                            }
                                            sekai_config::schema::WhatsAppChatPolicy::All => {
                                                // allow unconditionally
                                            }
                                            sekai_config::schema::WhatsAppChatPolicy::Allowlist => {
...
impl WhatsAppWebChannel {
    pub fn new(
        ...
        _mention_only: bool,
        _mode: sekai_config::schema::WhatsAppWebMode,
        _dm_policy: sekai_config::schema::WhatsAppChatPolicy,
        _group_policy: sekai_config::schema::WhatsAppChatPolicy,
        _self_chat_mode: bool,
    ) -> Self {
        Self { _private: () }
    }

    pub fn with_transcription(self, _config: sekai_config::schema::TranscriptionConfig) -> Self {
        self
    }

    pub fn with_tts(self, _config: sekai_config::schema::TtsConfig) -> Self {
        self
    }
}
...
mod tests {
    ...
    fn make_channel() -> WhatsAppWebChannel {
        WhatsAppWebChannel::new(
            ...
            vec!["+1234567890".into()],
            false,
            sekai_config::schema::WhatsAppWebMode::default(),
            sekai_config::schema::WhatsAppChatPolicy::default(),
            sekai_config::schema::WhatsAppChatPolicy::default(),
            false,
        )
    }
