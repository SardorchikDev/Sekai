...
impl WebhookChannel {
    ...
    fn http_client(&self) -> reqwest::Client {
        sekai_config::schema::build_runtime_proxy_client("channel.webhook")
    }
...
mod tests {
    ...
    fn incoming_payload_deserializes_all_fields() {
        let json = r#"{"sender": "sekai_user", "content": "hello", "thread_id": "t1"}"#;
        let payload: IncomingWebhook = serde_json::from_str(json).unwrap();
        assert_eq!(payload.sender, "sekai_user");
