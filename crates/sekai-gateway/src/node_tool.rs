//! Wraps a node capability as a sekai [`Tool`] so it can be dispatched
...
use sekai_tools::node_capabilities::requires_approval;

/// Default timeout for node invocations (30 seconds).
const NODE_INVOKE_TIMEOUT_SECS: u64 = 30;

/// A sekai [`Tool`] backed by a node capability.
///
