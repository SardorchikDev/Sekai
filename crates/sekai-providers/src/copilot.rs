...
/// Tokens are cached to `~/.config/sekai/copilot/` and refreshed
/// automatically.
...
impl CopilotProvider {
    pub fn new(github_token: Option<&str>) -> Self {
        let token_dir = directories::ProjectDirs::from("", "", "sekai")
            ...
            .unwrap_or_else(|| {
                ...
                std::env::temp_dir().join(format!("sekai-copilot-{user}"))
            });
