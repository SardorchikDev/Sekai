...
impl AnthropicProvider {
    ...
    pub fn with_base_url(credential: Option<&str>, base_url: Option<&str>) -> Self {
        ...
        Self {
            ...
            base_url,
            max_tokens: sekai_api::provider::BASELINE_MAX_TOKENS,
        }
    }
...
impl Provider for AnthropicProvider {
    ...
    async fn chat(
        ...
        let tool_choice_override = sekai_api::TOOL_CHOICE_OVERRIDE
...
data: {\"type\":\"message_stop\"}\n\n";
    ...
    fn chat_request_serializes_with_system() {
        let req = ChatRequest {
            model: "claude-3-opus".to_string(),
            max_tokens: 4096,
            system: Some("You are Sekai".to_string()),
            messages: vec![Message {
                role: "user".to_string(),
                content: "hello".to_string(),
            }],
        ...
        let json = serde_json::to_string(&req).unwrap();
        assert!(json.contains("\"system\":\"You are Sekai\""));
    }
