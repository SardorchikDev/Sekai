...
mod tests {
    ...
    // Arc<ModelAwareMock> Provider impl provided by blanket impl in sekai-types.
    ...
    // Arc<NativeModelAwareMock> Provider impl provided by blanket impl in sekai-types.
    ...
    // Arc<StreamingToolEventMock> Provider impl provided by blanket impl in sekai-types.
