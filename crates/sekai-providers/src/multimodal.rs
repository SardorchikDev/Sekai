...
use sekai_config::schema::{MultimodalConfig, build_runtime_proxy_client_with_timeouts};
...
/// (`crates/sekai-channels/src/util.rs::ATTACHMENT_KINDS`,
...
mod tests {
    ...
    fn strip_media_markers_replaces_image_local_path() {
        let input = "Look at [IMAGE:/sekai-data/workspace/telegram_files/photo_1.jpg]";
    ...
    fn strip_media_markers_replaces_all_supported_kinds() {
        ...
        // `crates/sekai-channels/src/util.rs`, which is the source of
