...
mod tests {
    ...
    // Arc<MockProvider> Provider impl provided by blanket impl in sekai-types.
    ...
    // Arc<StreamingMockProvider> Provider impl provided by blanket impl in sekai-types.
    ...
    // Arc<ToolEventStreamingMockProvider> Provider impl provided by blanket impl in sekai-types.
