...
use sekai_config::schema::ClaudeCodeRunnerConfig;
...
/// execution events back to Sekai's gateway endpoint, enabling live Slack
...
pub struct ClaudeCodeRunnerTool {
    ...
    /// Base URL of the Sekai gateway (e.g. `"http://localhost:3000"`).
    gateway_url: String,
}
