...
use sekai_api::provider::Provider;
use sekai_api::tool::{Tool, ToolResult};
use sekai_config::policy::SecurityPolicy;
use sekai_config::policy::ToolOperation;
use sekai_config::schema::{DelegateAgentConfig, SwarmConfig, SwarmStrategy};
...
impl SwarmTool {
    ...
    fn create_provider_for_agent(
        ...
        sekai_providers::create_provider_with_options(
    ...
    async fn execute_parallel(
        ...
        for agent_name in &swarm_config.agents {
            ...
            let provider = match sekai_providers::create_provider_with_options(
                &agent_config.provider,
                credential.as_deref(),
                &self.provider_runtime_options,
            ) {
