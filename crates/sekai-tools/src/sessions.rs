...
impl Tool for SessionsSendTool {
    ...
    async fn execute(&self, args: serde_json::Value) -> anyhow::Result<ToolResult> {
        ...
        let chat_msg = sekai_api::provider::ChatMessage::user(message);
...
impl Tool for SessionsCurrentTool {
    ...
    async fn execute(&self, _args: serde_json::Value) -> anyhow::Result<ToolResult> {
        let session_key = sekai_api::TOOL_LOOP_SESSION_KEY
...
mod tests {
    ...
    use sekai_api::provider::ChatMessage;
    use sekai_infra::session_store::SessionStore;
    ...
    async fn sessions_current_returns_key_when_scoped() {
        ...
        let result = sekai_api::TOOL_LOOP_SESSION_KEY
    ...
    async fn sessions_current_includes_name() {
        let tmp = TempDir::new().unwrap();
        let sqlite = sekai_infra::session_sqlite::SqliteSessionBackend::new(tmp.path()).unwrap();
