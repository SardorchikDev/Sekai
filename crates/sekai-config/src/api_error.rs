...
//! `sekai config` CLI subcommands returns this error type. The `code` field is
...
/// Structured error returned by the new HTTP CRUD endpoints and the `sekai config`
...
/// (`crates/sekai-config/src/schema.rs:10151+`). Adding a new pattern here
