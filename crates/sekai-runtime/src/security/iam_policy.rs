...
/// Maps a single Nevis role to Sekai permissions.
...
/// IAM policy engine that maps Nevis roles to Sekai tool permissions.
///
...
mod tests {
    ...
    fn test_mappings() -> Vec<RoleMapping> {
        vec![
            ...
            RoleMapping {
                ...
                sekai_permissions: vec!["file_read".into(), "memory_search".into()],
    ...
    fn duplicate_normalized_roles_are_rejected() {
        let mappings = vec![
            ...
            RoleMapping {
                nevis_role: " ADMIN ".into(),
                sekai_permissions: vec!["file_read".into()],
