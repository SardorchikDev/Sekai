...
use sekai_config::schema::OtpConfig;

const OTP_SECRET_FILE: &str = "otp-secret";
const OTP_DIGITS: u32 = 6;
const OTP_ISSUER: &str = "Sekai";
...
impl OtpValidator {
    pub fn from_config(
        ...
        let secret_path = secret_file_path(sekai_dir);
...
pub fn secret_file_path(sekai_dir: &Path) -> PathBuf {
    sekai_dir.join(OTP_SECRET_FILE)
}
