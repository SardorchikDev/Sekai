...
// Tool types from sekai-tools (direct imports, no shims)
pub use sekai_tools::ask_user::AskUserTool;
pub use sekai_tools::ask_user::ChannelMapHandle;
pub use sekai_tools::backup_tool::BackupTool;
pub use sekai_tools::browser::{BrowserTool, ComputerUseConfig};
pub use sekai_tools::browser_delegate::BrowserDelegateTool;
pub use sekai_tools::browser_open::BrowserOpenTool;
pub use sekai_tools::calculator::CalculatorTool;
pub use sekai_tools::canvas::{ALLOWED_CONTENT_TYPES, MAX_CONTENT_SIZE};
pub use sekai_tools::canvas::{CanvasStore, CanvasTool};
pub use sekai_tools::claude_code::ClaudeCodeTool;
pub use sekai_tools::claude_code_runner::ClaudeCodeRunnerTool;
pub use sekai_tools::cli_discovery::{DiscoveredCli, discover_cli_tools};
pub use sekai_tools::cloud_ops::CloudOpsTool;
pub use sekai_tools::cloud_patterns::CloudPatternsTool;
pub use sekai_tools::codex_cli::CodexCliTool;
pub use sekai_tools::composio::ComposioTool;
pub use sekai_tools::content_search::ContentSearchTool;
pub use sekai_tools::data_management::DataManagementTool;
pub use sekai_tools::discord_search::DiscordSearchTool;
pub use sekai_tools::escalate::EscalateToHumanTool;
pub use sekai_tools::file_edit::FileEditTool;
pub use sekai_tools::file_write::FileWriteTool;
pub use sekai_tools::gemini_cli::GeminiCliTool;
pub use sekai_tools::git_operations::GitOperationsTool;
pub use sekai_tools::glob_search::GlobSearchTool;
pub use sekai_tools::google_workspace::GoogleWorkspaceTool;
pub use sekai_tools::hardware_board_info::HardwareBoardInfoTool;
pub use sekai_tools::hardware_memory_map::HardwareMemoryMapTool;
pub use sekai_tools::hardware_memory_read::HardwareMemoryReadTool;
pub use sekai_tools::http_request::HttpRequestTool;
pub use sekai_tools::image_gen::ImageGenTool;
pub use sekai_tools::image_info::ImageInfoTool;
pub use sekai_tools::jira_tool::JiraTool;
pub use sekai_tools::knowledge_tool::KnowledgeTool;
pub use sekai_tools::linkedin::LinkedInTool;
pub use sekai_tools::llm_task::LlmTaskTool;
pub use sekai_tools::mcp_client::McpRegistry;
pub use sekai_tools::mcp_deferred::{
    ActivatedToolSet, DeferredMcpToolSet, build_deferred_tools_section,
};
pub use sekai_tools::mcp_tool::McpToolWrapper;
pub use sekai_tools::memory_export::MemoryExportTool;
pub use sekai_tools::memory_forget::MemoryForgetTool;
pub use sekai_tools::memory_purge::MemoryPurgeTool;
pub use sekai_tools::memory_recall::MemoryRecallTool;
pub use sekai_tools::memory_store::MemoryStoreTool;
pub use sekai_tools::microsoft365::Microsoft365Tool;
pub use sekai_tools::model_routing_config::ModelRoutingConfigTool;
pub use sekai_tools::notion_tool::NotionTool;
pub use sekai_tools::opencode_cli::OpenCodeCliTool;
#[cfg(feature = "rag-pdf")]
pub use sekai_tools::pdf_read::PdfReadTool;
pub use sekai_tools::pipeline::PipelineTool;
pub use sekai_tools::poll::PollTool;
pub use sekai_tools::project_intel::ProjectIntelTool;
pub use sekai_tools::proxy_config::ProxyConfigTool;
pub use sekai_tools::pushover::PushoverTool;
pub use sekai_tools::reaction::ReactionTool;
pub use sekai_tools::report_template_tool::ReportTemplateTool;
pub use sekai_tools::screenshot::ScreenshotTool;
pub use sekai_tools::sessions::{
    SessionDeleteTool, SessionResetTool, SessionsCurrentTool, SessionsHistoryTool,
    SessionsListTool, SessionsSendTool,
};
pub use sekai_tools::swarm::SwarmTool;
pub use sekai_tools::text_browser::TextBrowserTool;
pub use sekai_tools::tool_search::ToolSearchTool;
pub use sekai_tools::weather_tool::WeatherTool;
pub use sekai_tools::web_fetch::WebFetchTool;
pub use sekai_tools::web_search_tool::WebSearchTool;
pub use sekai_tools::workspace_tool::WorkspaceTool;
pub use sekai_tools::wrappers::{PathGuardedTool, RateLimitedTool};

// Traits from sekai-api
pub use sekai_api::schema::{CleaningStrategy, SchemaCleanr};
pub use sekai_api::tool::{Tool, ToolResult, ToolSpec};
...
use std::sync::Arc;
use sekai_config::schema::{Config, DelegateAgentConfig};
use sekai_memory::Memory;
...
pub fn all_tools(
    ...
    browser_config: &sekai_config::schema::BrowserConfig,
    http_config: &sekai_config::schema::HttpRequestConfig,
    web_fetch_config: &sekai_config::schema::WebFetchConfig,
    workspace_dir: &std::path::Path,
    agents: &HashMap<String, DelegateAgentConfig>,
    fallback_api_key: Option<&str>,
    root_config: &sekai_config::schema::Config,
...
pub fn all_tools_with_runtime(
    ...
    if root_config.channels.discord_history.is_some() {
        match sekai_memory::SqliteMemory::new_named(workspace_dir, "discord") {
            Ok(discord_mem) => {
    ...
    // LLM task tool — always registered when a provider is configured
    {
        ...
        let llm_task_runtime_options =
            sekai_providers::provider_runtime_options_from_config(root_config);
    ...
    if let Ok(backend) =
        sekai_infra::make_session_backend(workspace_dir, &config.channels.session_backend)
    {
        ...
        // sekai_tools::sessions but NOT registered by default. They are
    ...
    if root_config.microsoft365.enabled {
        ...
        if !tenant_id.is_empty() && !client_id.is_empty() {
            ...
            let resolved = sekai_tools::microsoft365::types::Microsoft365ResolvedConfig {
                tenant_id,
                client_id,
    ...
    if root_config.knowledge.enabled {
        ...
        match sekai_memory::knowledge_graph::KnowledgeGraph::new(
            &db_path,
    ...
    if root_config.workspace.enabled {
        ...
        let mut ws_manager = sekai_config::workspace::WorkspaceManager::new(workspaces_dir);
    ...
    #[cfg(feature = "plugins-wasm")]
    {
        ...
        if plugin_path.exists() && config.plugins.enabled {
            match sekai_plugins::host::PluginHost::new(
                ...
                Ok(host) => {
                    ...
                    for (manifest, wasm_path) in details {
                        tool_arcs.push(Arc::new(sekai_plugins::wasm_tool::WasmTool::from_wasm(
...
mod tests {
    ...
    use sekai_config::schema::{BrowserConfig, Config, MemoryConfig};
    ...
    fn all_tools_excludes_browser_when_disabled() {
        ...
        let mem: Arc<dyn Memory> =
            Arc::from(sekai_memory::create_memory(&mem_cfg, tmp.path(), None).unwrap());
        ...
        let http = sekai_config::schema::HttpRequestConfig::default();
        ...
        let (tools, _, _, _, _, _) = all_tools(
            ...
            &browser,
            &http,
            &sekai_config::schema::WebFetchConfig::default(),
            tmp.path(),
            &HashMap::new(),
            None,
            &cfg,
    ...
    fn all_tools_excludes_read_skill_in_full_mode() {
        ...
        let http = sekai_config::schema::HttpRequestConfig::default();
        let mut cfg = test_config(&tmp);
        cfg.skills.prompt_injection_mode = sekai_config::schema::SkillsPromptInjectionMode::Full;
