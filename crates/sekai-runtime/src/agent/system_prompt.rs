...
pub fn build_system_prompt_with_mode(
    ...
    let autonomy_cfg = sekai_config::schema::AutonomyConfig {
...
pub fn build_system_prompt_with_mode_and_autonomy(
    ...
    identity_config: Option<&sekai_config::schema::IdentityConfig>,
    bootstrap_max_chars: Option<usize>,
    autonomy_config: Option<&sekai_config::schema::AutonomyConfig>,
    native_tools: bool,
    skills_prompt_mode: sekai_config::schema::SkillsPromptInjectionMode,
    ...
    if prompt.is_empty() {
        "You are Sekai, a fast and efficient AI assistant built in Rust. Be helpful, concise, and direct."
            .to_string()
    } else {
        prompt
    }
