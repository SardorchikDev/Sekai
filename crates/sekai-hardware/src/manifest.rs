//! Plugin manifest — `~/.sekai/tools/<name>/tool.toml` schema.
//!
...
/// Execution configuration — how Sekai spawns the tool.
#[derive(Debug, Deserialize)]
...
///
/// When present, Sekai will prefer the named transport kind
