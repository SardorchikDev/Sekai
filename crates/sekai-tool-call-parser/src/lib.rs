...
/// <FunctionCall>
/// file_read
/// <code>path>/Users/kylelampa/Documents/sekai/README.md</code>
/// </FunctionCall>
/// ```
...
/// Map tool name aliases from various LLM providers to Sekai tool names.
...
/// to. This function encodes the mapping for known Sekai tools.
...
pub fn parse_tool_calls(response: &str) -> (String, Vec<ParsedToolCall>) {
    ...
    // 2. Sekai tool-call tags (<tool_call>, <toolcall>, <tool-call>)
...
Let me check the result."#;
    ...
    // ═══════════════════════════════════════════════════════════════════════
    // Additional parser internals tests (moved from sekai-runtime to keep
