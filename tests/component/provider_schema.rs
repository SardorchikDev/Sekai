...
use sekai::providers::compatible::AuthStyle;
use sekai::providers::traits::{ChatMessage, ChatResponse, ToolCall};
...
fn provider_construction_with_different_names() {
    use sekai::providers::compatible::OpenAiCompatibleProvider;
