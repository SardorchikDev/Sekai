...
//! verification) in isolation. The gateway module (`sekai::gateway`) exposes
...
use sekai::gateway::verify_whatsapp_signature;
...
fn gateway_timeout_is_reasonable() {
    assert_eq!(
        sekai::gateway::REQUEST_TIMEOUT_SECS,
        30,
...
fn gateway_rate_limit_window_is_60s() {
    assert_eq!(
        sekai::gateway::RATE_LIMIT_WINDOW_SECS,
        60,
