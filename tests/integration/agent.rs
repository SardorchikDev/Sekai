...
//!
//! Ref: <https://github.com/sekai-labs/sekai/issues/618> (item 6)
...
use sekai::providers::{ChatResponse, ConversationMessage, ToolCall};
...
async fn e2e_multi_turn_with_memory_enrichment() {
    ...
    assert!(req1_user.content.contains("project: sekai"));
