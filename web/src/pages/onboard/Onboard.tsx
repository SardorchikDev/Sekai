// Schema-driven onboarding wizard mirroring `sekai onboard` (#6175).
//
// Layout:
...
// Wizard sections in TUI order (`sekai onboard`'s `Section::as_path_prefix`
// dispatch in `crates/sekai-runtime/src/onboard/mod.rs`). The dashboard
