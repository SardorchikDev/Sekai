...
bump "marketplace/dokploy/blueprints/sekai/docker-compose.yml" \
  'ghcr\.io/sekai-labs/sekai:[0-9]+\.[0-9]+\.[0-9]+' \
  "ghcr.io/sekai-labs/sekai:${VERSION}"
...
#   - container image tags    `sekailabs/sekai:vX.Y.Z`
...
for f in "${docs_files[@]}"; do
  ...
  bump "$rel" \
    'sekailabs/sekai:v[0-9]+\.[0-9]+\.[0-9]+' \
    "sekailabs/sekai:v${VERSION}"
