//! HTTP client for communicating with the Sekai gateway.
...
mod tests {
    ...
    fn client_custom_url() {
        let client = GatewayClient::new("https://sekai.example.com:9999", None);
        assert_eq!(client.base_url, "https://sekai.example.com:9999");
    }
