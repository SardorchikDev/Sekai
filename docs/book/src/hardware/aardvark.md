...
**File:** `crates/sekai-hardware/src/aardvark.rs`

The rest of Sekai speaks a single language: `ZcCommand` → `ZcResponse`.
...
**File:** `crates/sekai-hardware/src/aardvark_tools.rs`
...
DatasheetTool.call(args)
  ...
  → "download": fetch PDF from args["url"] → save to ~/.sekai/hardware/datasheets/
...
**File:** `crates/sekai-hardware/src/device.rs`
...
**File:** `crates/sekai-hardware/src/lib.rs`
...
**File:** `crates/sekai-hardware/src/tool_registry.rs`
...
```
 SDK FILES          aardvark-sys            Sekai core
 (vendor/)          (crates/)               (src/)
─────────────────────────────────────────────────────────────────
