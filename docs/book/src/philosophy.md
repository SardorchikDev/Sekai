...
Sekai is built on four opinions, in priority order.
...
- Emergency stop (`sekai estop`) and OTP-gated actions
...
- **Not a framework.** You don't build apps on top of Sekai. You configure it and connect channels.
- **Not a toy.** Production deployments run 24/7 on homelab SBCs, VPSes, and cloud VMs. The `sekai service` subcommand manages systemd / launchctl / Windows Service registration out of the box.
...
- **[#5574](https://github.com/sekai-labs/sekai/issues/5574)** — Microkernel transition (v0.7.0 → v1.0.0). Crate splits, feature-flag taxonomy.
- **[#5576]((https://github.com/sekai-labs/sekai/issues/5576)** — Documentation standards and knowledge architecture.
- **[#5577]((https://github.com/sekai-labs/sekai/issues/5577)** — Project governance: core-team structure, two-thirds-majority voting.
- **[#5579]((https://github.com/sekai-labs/sekai/issues/5579)** — Engineering infrastructure: CI pipelines, release automation.
- **[#5615]((https://github.com/sekai-labs/sekai/issues/5615)** — Contribution culture: human/AI co-authorship norms.
- **[#5653]((https://github.com/sekai-labs/sekai/issues/5653)** — Zero Compromise: error handling, dead-code policy, release-readiness.
