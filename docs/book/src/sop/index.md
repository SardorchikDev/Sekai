...
- CLI `sekai sop` currently manages definitions only: `list`, `validate`, `show`.
...
2. Create a SOP directory, for example:
   ...
   ```text
   ~/.sekai/workspace/sops/deploy-prod/SOP.toml
   ~/.sekai/workspace/sops/deploy-prod/SOP.md
   ```
