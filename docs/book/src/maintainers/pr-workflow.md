...
- Identity-like wording, where unavoidable, uses Sekai / project-native labels.
...
- `crates/sekai-runtime/src/security/`
- The rest of `crates/sekai-runtime/`
- `crates/sekai-gateway/` (ingress, authentication, pairing)
- `crates/sekai-tools/` (anything with execution capability)
