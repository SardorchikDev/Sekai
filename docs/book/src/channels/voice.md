...
**Pair with:** a `telnyx` provider for the brain (`crates/sekai-providers/src/telnyx.rs`) and ensure your Telnyx account has a SIP connection with the correct webhook URL pointed at the Sekai gateway.
...
model_path = "~/.sekai/wake/hey-claw.ppn"
...
credentials_json = "~/.sekai/gcp.json"
