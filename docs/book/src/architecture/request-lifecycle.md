...
- Agent loop: `crates/sekai-runtime/src/agent/loop_.rs`
- Tool-call validation: `crates/sekai-runtime/src/security/`
- Channel orchestration: `crates/sekai-channels/src/orchestrator/`
- Provider streaming: `crates/sekai-providers/src/traits.rs` (`StreamEvent` enum), `compatible.rs` (SSE parser)
