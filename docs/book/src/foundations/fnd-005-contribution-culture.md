...
> Discussion thread and full revision history: [#5615](https://github.com/sekai-labs/sekai/issues/5615)
...
>
> This is the fifth document in Sekai's maturity framework. The other four address
...
This RFC is the fifth in a set of five documents that together form Sekai's maturity
...
Sekai itself is a useful example. The initial codebase was bootstrapped with AI
