...
> Discussion thread and full revision history: [#5577](https://github.com/sekai-labs/sekai/issues/5577)
...
| 🎉 **Show and Tell** | Open-ended discussion | What are you building with Sekai? Community showcases |
...
**GitHub Teams** in the organization settings — `sekai-core` and `sekai-contributors` teams, referenced in CODEOWNERS and used for notification routing.
...
src/security/**                 @sekai-labs/sekai-core
src/gateway/**                  @sekai-labs/sekai-core
src/runtime/**                  @sekai-labs/sekai-core
src/tools/shell.rs              @sekai-labs/sekai-core
src/tools/file_write.rs         @sekai-labs/sekai-core
src/tools/security_ops.rs       @sekai-labs/sekai-core

# ── Governance and configuration: requires Core Team approval ───────────────

.github/**                      @sekai-labs/sekai-core
CODEOWNERS                      @sekai-labs/sekai-core
Cargo.toml                      @sekai-labs/sekai-core
deny.toml                       @sekai-labs/sekai-core

# ── Architecture documents: requires Core Team review ───────────────────────

docs/proposals/**               @sekai-labs/sekai-core
docs/architecture/decisions/**  @sekai-labs/sekai-core
AGENTS.md                       @sekai-labs/sekai-core

# ── Default: any Contributor or Core Team member can review ─────────────────

*                               @sekai-labs/sekai-contributors
```
...
As the workspace decomposes into crates (per the architecture RFC), add per-crate checks. A change to `crates/sekai-api` should run that crate's test suite independently.
...
body:
  ...
  - type: input
    ...
    attributes:
      ...
      placeholder: "https://github.com/sekai-labs/sekai/pull/..."
    validations:
      required: true
  - type: textarea
    id: summary
  ...
  - type: markdown
    attributes:
      value: |
        ...
        put all Sekai users at risk. Please follow the private disclosure
        process described in [SECURITY.md](https://github.com/sekai-labs/sekai/blob/master/SECURITY.md).
...
- [ ] Create the `sekai-core` and `sekai-contributors` GitHub Teams
